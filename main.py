...
parser.add_argument('--model_type', type=str, choices=['clam_sb', 'clam_mb', 'mil', 'clam_mh', 'ABMIL', 'TransMIL', 'TransMIL_CLAM', 'ABMIL_CLAM'], default='clam_sb', 
                    help='type of model (default: clam_sb, clam w/ single attention branch)')
parser.add_argument('--exp_code', type=str, help='experiment code for saving results')
parser.add_argument('--weighted_sample', action='store_true', default=False, help='enable weighted sampling')
parser.add_argument('--model_size', type=str, choices=['small', 'big'], default='small', help='size of model, does not affect mil')
parser.add_argument('--task', type=str, choices=['task_1_tumor_vs_normal',  'task_2_tumor_subtyping', 'HPV', 
                    'HPV2', 'HPV512', 'HPV_cesc', 'HPV_cesc_sur', 'cesc_lusc', 'cesc_lusc_sur', 'HPV_cesc_subtypes',
                    'CPTAC_HNSCC_CESC'], required=True,
                    help='task to run, must be specified')
...
parser.add_argument('--head_pool', type=str, default='concat', choices=['concat','mean','max'])

parser.add_argument('--d_model', type=int, default=512)
parser.add_argument('--n_layers', type=int, default=2)
parser.add_argument('--n_heads_tx', type=int, default=4)          # encoder heads
parser.add_argument('--ff_dim', type=int, default=1024)
parser.add_argument('--attn_pool_heads', type=int, default=4)
